...
export const createAboutContentBorderStyles = (params:IcreateAboutContentBorderStyles) => {
    const { direction, isOneSelected, isSelecting, isDeselecting, isSwitching, screenHeight } = params;
    const borderHeight =  screenHeight - PAGE_CONSTANTS.MARGIN_BOTTOM - PAGE_CONSTANTS.MARGIN_TOP - ABOUT_MENU_CONSTANTS.HEIGHT;
