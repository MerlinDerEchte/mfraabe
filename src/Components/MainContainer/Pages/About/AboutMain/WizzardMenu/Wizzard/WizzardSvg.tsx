...
import { WizzardWrapperStyles, createLightBallStyles } from './WizzardSvgStyles';
import { MousePositionContext } from '../../MousePositionContext';
import { IPosition } from '../../../../../../../Types/IPosition';
// #11ff11
export const WizzardSVG:react.FC<IPosition> = (offset:IPosition) =>{

    const getRelativeLightPosition = (mousePositions:IPosition) => {
    ...
    const mousePositions:IPosition = useContext(MousePositionContext);
    const lightBallPosition = getRelativeLightPosition(mousePositions)
    const lightballStyles = createLightBallStyles(lightBallPosition.mouseX, lightBallPosition.mouseY);
