...
import { MOBILE_PAGE_MENU_TOGGLE_CONSTANTS } from '../GlobalConstantsMobile';
    ...
    const { isRun, screenWidth, isShowMobileMenu, isShowMobileMenuAnimation, isHideMobileMenuAnimation } = params;
        ...
        return css({
            ...
            left: isShowMobileMenu ?
                screenWidth - MOBILE_MENU_TOGGLE_CONSTANTS.SHOW_MENU_RIGHT  - MOBILE_PAGE_MENU_TOGGLE_CONSTANTS.WIDTH
                :
            ...
            height: MOBILE_PAGE_MENU_TOGGLE_CONSTANTS.HEIGHT,
        })  
